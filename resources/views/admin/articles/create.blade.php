        ...
        <div class="max-w-[1000px] mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="bg-white rounded-[40px] border border-slate-200 overflow-hidden shadow-2xl">
                ...
                <form
                    ...
                    <div class="grid md:grid-cols-3 gap-8">
                        <div class="space-y-3">
                            ...
                            <select name="type" id="article_type"
                                ...
                                <option value="manual" {{ old('type', $article->type ?? '') == 'manual' ? 'selected' : '' }}>
                                    Konten Manual</option>
                    ...
                    <!-- Conditional Fields -->
                    <div id="manual_field"
                        class="space-y-3 {{ old('type', $article->type ?? 'manual') == 'link' ? 'hidden' : '' }}">
                    ...
                    <div id="link_field"
                        class="space-y-3 {{ old('type', $article->type ?? 'manual') == 'manual' ? 'hidden' : '' }}">
                    ...
                    <div class="pt-6 border-t border-slate-100 flex justify-end">
                        <button type="submit"
                            ...
                            {{ isset($article) ? 'Simpan Perubahan' : 'Publikasikan Artikel' }}
                        </button>
                    </div>
                </form>
            </div>
