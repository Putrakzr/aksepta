...
@section('title', 'Manage Projects - Admin Control')
        ...
        <div class="bg-white rounded-3xl border border-slate-200 overflow-hidden shadow-xl">
            <div class="bg-slate-900 p-10 text-white relative">
                ...
                <div class="relative z-10 flex items-center justify-between">
                    <div>
                        <h1 class="text-4xl font-display font-black tracking-tight">{{ isset($project) ? 'Edit' : 'Buat' }} Proyek.</h1>
            ...
            <form action="{{ isset($project) ? route('admin.projects.update', $project) : route('admin.projects.store') }}" method="POST" class="p-12 space-y-10">
                @csrf
                ...
                <div class="grid md:grid-cols-2 gap-10">
                    ...
                    <div class="space-y-3 md:col-span-2">
                        <label class="px-4 text-[10px] font-black text-slate-400 uppercase tracking-[0.3em]">Aset Visual (URL Gambar)</label>
                        <div class="relative">
                            ...
                            <div class="absolute right-6 top-1/2 -translate-y-1/2 w-12 h-12 bg-slate-100 rounded-2xl flex items-center justify-center">
