...
@section('content')
    ...
    <section class="relative min-h-[60vh] flex items-center pt-24 pb-20 overflow-hidden bg-[#020617]">
        ...
        <div class="absolute inset-0 z-0">
            <!-- Base Gradient Mesh -->
            <div class="absolute inset-0 bg-[radial-gradient(circle_at_20%_30%,rgba(245,158,11,0.15)_0%,transparent_50%)]">
            </div>
            <div class="absolute inset-0 bg-[radial-gradient(circle_at_80%_70%,rgba(217,119,6,0.08)_0%,transparent_50%)]">
            </div>
            ...
            <!-- Dynamic Glows -->
            <div
                class="absolute top-[-10%] right-[-5%] w-[500px] h-[500px] bg-amber-600/10 blur-[120px] rounded-full animate-pulse">
            </div>
            <div class="absolute bottom-[-10%] left-[-5%] w-[400px] h-[400px] bg-yellow-600/10 blur-[100px] rounded-full animate-pulse"
        ...
        <div class="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="max-w-4xl space-y-10">
                ...
                <div class="inline-flex items-center gap-3 px-5 py-2.5 bg-white/5 backdrop-blur-2xl rounded-full border border-white/10 shadow-2xl animate-fade-in translate-y-4 opacity-0"
                    ...
                    <span class="text-[10px] font-black text-amber-300 uppercase tracking-[0.4em]">Strategic Advisory
                        SBU</span>
                </div>
                ...
                <div class="flex flex-wrap gap-5 pt-6 animate-slide-up opacity-0"
                    ...
                    <a href="#focus"
                        class="group relative px-8 py-4 bg-amber-600 text-white font-black text-lg rounded-2xl shadow-[0_0_40px_-5px_rgba(245,158,11,0.4)] hover:shadow-[0_0_50px_-5px_rgba(245,158,11,0.6)] hover:bg-amber-500 transition-all duration-500 flex items-center gap-3 overflow-hidden">
                        ...
                        <div
                            class="absolute inset-0 bg-gradient-to-r from-amber-400/0 via-white/10 to-amber-400/0 -translate-x-[100%] group-hover:translate-x-[100%] transition-transform duration-1000 ease-in-out">
                        </div>
                    </a>
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="grid lg:grid-cols-2 gap-24 items-start">
                <div class="space-y-12 sticky top-32">
                    ...
                    <div
                        class="p-6 bg-amber-50 rounded-[32px] border border-amber-100 flex items-center gap-5 group hover:bg-white hover:shadow-2xl transition-all duration-500">
                        <div
                            class="w-14 h-14 bg-amber-600 text-white rounded-xl flex items-center justify-center flex-shrink-0 animate-pulse">
                ...
                <div class="grid gap-6">
                    ...
                    <div
                        ...
                        <div class="flex gap-6 items-start">
                            <div
                                class="w-12 h-12 bg-amber-100 rounded-xl flex items-center justify-center text-amber-600 group-hover:bg-amber-600 group-hover:text-white transition-all duration-500">
                                <i data-lucide="scroll" class="w-8 h-8"></i>
                            </div>
                            <div class="space-y-3">
                                <h4 class="text-2xl font-bold text-slate-900 tracking-tight">Business Plan</h4>
                                <p class="text-slate-600 leading-relaxed">Penyusunan Rencana Strategis (Renstra) dan
                                    proposal bisnis yang komprehensif bagi korporasi dan pemerintah.</p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div
                        ...
                        <div class="flex gap-6 items-start">
                            <div
                                class="w-12 h-12 bg-yellow-100 rounded-xl flex items-center justify-center text-yellow-600 group-hover:bg-yellow-600 group-hover:text-white transition-all duration-500">
                                <i data-lucide="search" class="w-8 h-8"></i>
                            </div>
                            <div class="space-y-3">
                                <h4 class="text-2xl font-bold text-slate-900 tracking-tight">Market Research</h4>
                                <p class="text-slate-600 leading-relaxed">Kajian Kelayakan (Feasibility Study) dan riset
                                    intelijen pasar untuk memitigasi risiko investasi.</p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div
                        ...
                        <div class="flex gap-6 items-start">
                            ...
                            <div class="space-y-3">
                                ...
                                <p class="text-slate-600 leading-relaxed">Perancangan tata kelola organisasi dan Standard
                                    Operating Procedure (SOP) untuk efisiensi operasional.</p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div
                        ...
                        <div class="flex gap-6 items-start">
                            ...
                            <div class="space-y-3">
                                ...
                                <p class="text-slate-600 leading-relaxed">Konsultasi perizinan bisnis dan kepatuhan hukum
                                    untuk memastikan keamanan operasional jangka panjang.</p>
                            </div>
                        </div>
                    </div>
                </div>
    ...
    <section class="py-16 bg-slate-900 relative overflow-hidden">
        <!-- Abstract Decoration -->
        <div
            class="absolute top-0 right-0 w-full h-full bg-[radial-gradient(circle_at_80%_20%,#451a03_0%,transparent_50%)]">
        </div>
        ...
        <div class="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center space-y-20">
            ...
            <div
                ...
                <div class="grid md:grid-cols-3 gap-10 relative z-10">
                    <div class="space-y-4">
                        <div
                            class="text-5xl md:text-7xl font-display font-black text-white leading-none tracking-tighter group-hover:text-amber-400 transition-colors duration-700">
                            50+</div>
                        <div class="w-12 h-1 bg-amber-500 mx-auto rounded-full"></div>
                        <p class="text-slate-400 text-lg">Kajian Strategis dan Feasibility Study yang telah kami selesaikan.
                        </p>
                    </div>
                    <div class="space-y-4">
                        <div
                            ...
                            100%</div>
                        <div class="w-12 h-1 bg-amber-500 mx-auto rounded-full"></div>
                        <p class="text-slate-400 text-lg">Akurasi data riset primer yang dihimpun langsung dari intelijen
                            pasar.</p>
                    </div>
                    <div class="space-y-4">
                        <div
                            ...
                            200+</div>
                        <div class="w-12 h-1 bg-amber-500 mx-auto rounded-full"></div>
                        <p class="text-slate-400 text-lg">Rekomendasi kebijakan strategis yang telah diimplementasikan
                            klien.</p>
                    </div>
                </div>
            </div>
            ...
            <div class="grid md:grid-cols-3 gap-6">
                <div
                    ...
                    <div class="relative z-10 space-y-6">
                        ...
                        <p class="text-slate-600 text-lg leading-relaxed">
                            <span class="text-slate-900 font-bold">ABCO</span> memberikan intelijen pasar yang menjadi basis
                            bagi <span class="text-slate-900 font-bold">ADMA</span> untuk merancang strategi pemasaran.
                        </p>
                    </div>
                </div>
                ...
                <div
                    ...
                    <div class="relative z-10 space-y-6">
                        ...
                        <p class="text-slate-600 text-lg leading-relaxed">
                            Riset kelayakan dari <span class="text-slate-900 font-bold">ABCO</span> memandu <span
                                class="text-slate-900 font-bold">ARIO</span> dalam pengambilan keputusan investasi sektor
                            riil.
                        </p>
                    </div>
                </div>
                ...
                <div
                    ...
                    <div class="relative z-10 space-y-6">
                        ...
                        <p class="text-slate-600 text-lg leading-relaxed">
                            <span class="text-slate-900 font-bold">ABCO</span> merancang SOP bisnis, yang kemudian
                            didigitalisasi oleh <span class="text-slate-900 font-bold">ADDS</span> ke dalam sistem manajemen
                            kustom.
                        </p>
                    </div>
                </div>
