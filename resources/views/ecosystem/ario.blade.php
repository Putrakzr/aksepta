...
@section('title', 'ARIO - Perdagangan Sektor Riil & Pengadaan B2B')
...
@section('content')
    ...
    <section class="relative min-h-[60vh] flex items-center pt-24 pb-20 overflow-hidden bg-[#020617]">
        ...
        <div class="absolute inset-0 z-0">
            <!-- Base Gradient Mesh -->
            <div class="absolute inset-0 bg-[radial-gradient(circle_at_20%_30%,rgba(244,63,94,0.15)_0%,transparent_50%)]"></div>
            <div class="absolute inset-0 bg-[radial-gradient(circle_at_80%_70%,rgba(225,29,72,0.08)_0%,transparent_50%)]"></div>
            ...
            <!-- Dynamic Glows -->
            <div class="absolute top-[-10%] right-[-5%] w-[500px] h-[500px] bg-rose-600/10 blur-[120px] rounded-full animate-pulse"></div>
            <div class="absolute bottom-[-10%] left-[-5%] w-[400px] h-[400px] bg-orange-600/10 blur-[100px] rounded-full animate-pulse" style="animation-delay: 2s;"></div>
        </div>
        ...
        <div class="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="max-w-4xl space-y-10">
                ...
                <div class="inline-flex items-center gap-3 px-5 py-2.5 bg-white/5 backdrop-blur-2xl rounded-full border border-white/10 shadow-2xl animate-fade-in translate-y-4 opacity-0" style="animation-fill-mode: forwards;">
                    ...
                    <span class="text-[10px] font-black text-rose-300 uppercase tracking-[0.4em]">Real Sector Operations SBU</span>
                </div>
                ...
                <div class="flex flex-wrap gap-5 pt-6 animate-slide-up opacity-0" style="animation-delay: 600ms; animation-fill-mode: forwards;">
                    <a href="#focus" class="group relative px-8 py-4 bg-rose-600 text-white font-black text-lg rounded-2xl shadow-[0_0_40px_-5px_rgba(244,63,94,0.4)] hover:shadow-[0_0_50px_-5px_rgba(244,63,94,0.6)] hover:bg-rose-500 transition-all duration-500 flex items-center gap-3 overflow-hidden">
                        <span class="relative z-10">Jelajahi Operasi</span>
                        <i data-lucide="truck" class="w-5 h-5 relative z-10 transition-transform duration-500 group-hover:scale-110"></i>
                        <div class="absolute inset-0 bg-gradient-to-r from-rose-400/0 via-white/10 to-rose-400/0 -translate-x-[100%] group-hover:translate-x-[100%] transition-transform duration-1000 ease-in-out"></div>
                    </a>
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="grid lg:grid-cols-2 gap-24 items-start">
                <div class="space-y-12 sticky top-32">
                    ...
                    <div class="p-6 bg-rose-50 rounded-[32px] border border-rose-100 flex items-center gap-5 group hover:bg-white hover:shadow-2xl transition-all duration-500">
                        <div class="w-14 h-14 bg-rose-600 text-white rounded-xl flex items-center justify-center flex-shrink-0 animate-pulse">
                    ...
                    <div class="p-8 bg-slate-50 border border-slate-100 rounded-[40px] hover:bg-white hover:shadow-2xl hover:-translate-y-2 transition-all duration-500 group">
                        <div class="flex gap-6 items-start">
                            ...
                            <div class="space-y-3">
                                ...
                                <p class="text-slate-600 leading-relaxed">Penyediaan barang dan jasa berkualitas untuk kebutuhan instansi pemerintah dan swasta secara transparan.</p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="p-8 bg-slate-50 border border-slate-100 rounded-[40px] hover:bg-white hover:shadow-2xl hover:-translate-y-2 transition-all duration-500 group">
                        <div class="flex gap-6 items-start">
                            ...
                            <div class="space-y-3">
                                ...
                                <p class="text-slate-600 leading-relaxed">Pengelolaan jaringan outlet ritel dan strategi distribusi produk langsung ke konsumen akhir.</p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="p-8 bg-slate-50 border border-slate-100 rounded-[40px] hover:bg-white hover:shadow-2xl hover:-translate-y-2 transition-all duration-500 group">
                        <div class="flex gap-6 items-start">
                            ...
                            <div class="space-y-3">
                                ...
                                <p class="text-slate-600 leading-relaxed">Penempatan modal strategis pada unit bisnis sektor riil yang mendukung pertumbuhan ekosistem Aksepta.</p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="p-8 bg-slate-50 border border-slate-100 rounded-[40px] hover:bg-white hover:shadow-2xl hover:-translate-y-2 transition-all duration-500 group">
                        <div class="flex gap-6 items-start">
                            ...
                            <div class="space-y-3">
                                ...
                                <p class="text-slate-600 leading-relaxed">Optimalisasi logistik dan aliran barang dari produsen hingga ke titik distribusi akhir.</p>
                            </div>
                        </div>
                    </div>
                </div>
    ...
    <section class="py-16 bg-slate-900 relative overflow-hidden">
        <!-- Abstract Decoration -->
        <div class="absolute top-0 right-0 w-full h-full bg-[radial-gradient(circle_at_80%_20%,#450a0a_0%,transparent_50%)]"></div>
        ...
        <div class="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center space-y-20">
            ...
            <div class="relative bg-white/5 backdrop-blur-2xl border border-white/10 rounded-[48px] p-10 md:p-14 shadow-3xl group overflow-hidden">
                ...
                <div class="grid md:grid-cols-3 gap-10 relative z-10">
                    <div class="space-y-4">
                        <div class="text-5xl md:text-7xl font-display font-black text-white leading-none tracking-tighter group-hover:text-rose-400 transition-colors duration-700">15+</div>
                        <div class="w-12 h-1 bg-rose-500 mx-auto rounded-full"></div>
                        <p class="text-slate-400 text-lg">Mitra distribusi ritel yang terhubung dalam satu jaringan logistik.</p>
                    </div>
                    <div class="space-y-4">
                        <div class="text-5xl md:text-7xl font-display font-black text-white leading-none tracking-tighter group-hover:text-rose-400 transition-colors duration-700">95%</div>
                        <div class="w-12 h-1 bg-rose-500 mx-auto rounded-full"></div>
                        <p class="text-slate-400 text-lg">On-time delivery rate untuk seluruh proyek pengadaan B2B kami.</p>
                    </div>
                    <div class="space-y-4">
                        <div class="text-5xl md:text-7xl font-display font-black text-white leading-none tracking-tighter group-hover:text-rose-400 transition-colors duration-700">24h</div>
                        <div class="w-12 h-1 bg-rose-500 mx-auto rounded-full"></div>
                        <p class="text-slate-400 text-lg">Respon sistem pengadaan (Fast-Procure) untuk kebutuhan mendesak.</p>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="grid md:grid-cols-3 gap-6">
                <div class="group relative p-8 bg-white rounded-[40px] shadow-sm border border-slate-100 hover:shadow-2xl transition-all duration-700 overflow-hidden">
                    ...
                    <div class="relative z-10 space-y-6">
                        ...
                        <p class="text-slate-600 text-lg leading-relaxed">
                            <span class="text-slate-900 font-bold">ADMA</span> merancang strategi pemasaran produk, dan <span class="text-slate-900 font-bold">ARIO</span> mengeksekusi distribusi fisiknya ke titik pasar.
                        </p>
                    </div>
                </div>
                ...
                <div class="group relative p-8 bg-white rounded-[40px] shadow-sm border border-slate-100 hover:shadow-2xl transition-all duration-700 overflow-hidden">
                    ...
                    <div class="relative z-10 space-y-6">
                        ...
                        <p class="text-slate-600 text-lg leading-relaxed">
                            <span class="text-slate-900 font-bold">ADDS</span> membangun sistem otomasi inventaris (ERP) untuk mendukung efisiensi supply chain <span class="text-slate-900 font-bold">ARIO</span>.
                        </p>
                    </div>
                </div>
                ...
                <div class="group relative p-8 bg-white rounded-[40px] shadow-sm border border-slate-100 hover:shadow-2xl transition-all duration-700 overflow-hidden">
                    ...
                    <div class="relative z-10 space-y-6">
                        ...
                        <p class="text-slate-600 text-lg leading-relaxed">
                            <span class="text-slate-900 font-bold">ABCO</span> melakukan riset permintaan pasar, yang menjadi landasan bagi <span class="text-slate-900 font-bold">ARIO</span> untuk melakukan pengadaan barang yang tepat.
                        </p>
                    </div>
                </div>
            </div>
