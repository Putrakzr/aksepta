...
@section('title', 'ADDS - Rekayasa Perangkat Lunak & Infrastruktur IT')
...
@section('content')
    ...
    <section class="relative min-h-[60vh] flex items-center pt-24 pb-20 overflow-hidden bg-[#020617]">
        ...
        <div class="absolute inset-0 z-0">
            <!-- Base Gradient Mesh -->
            <div class="absolute inset-0 bg-[radial-gradient(circle_at_20%_30%,rgba(79,70,229,0.15)_0%,transparent_50%)]"></div>
            <div class="absolute inset-0 bg-[radial-gradient(circle_at_80%_70%,rgba(67,56,202,0.08)_0%,transparent_50%)]"></div>
            ...
            <!-- Dynamic Glows -->
            <div class="absolute top-[-10%] right-[-5%] w-[500px] h-[500px] bg-indigo-600/10 blur-[120px] rounded-full animate-pulse"></div>
            <div class="absolute bottom-[-10%] left-[-5%] w-[400px] h-[400px] bg-blue-600/10 blur-[100px] rounded-full animate-pulse" style="animation-delay: 2s;"></div>
        </div>
        ...
        <div class="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="max-w-4xl space-y-10">
                ...
                <div class="inline-flex items-center gap-3 px-5 py-2.5 bg-white/5 backdrop-blur-2xl rounded-full border border-white/10 shadow-2xl animate-fade-in translate-y-4 opacity-0" style="animation-fill-mode: forwards;">
                    ...
                    <span class="text-[10px] font-black text-indigo-300 uppercase tracking-[0.4em]">Tech Stack & Engineering</span>
                </div>
                ...
                <div class="flex flex-wrap gap-5 pt-6 animate-slide-up opacity-0" style="animation-delay: 600ms; animation-fill-mode: forwards;">
                    <a href="#focus" class="group relative px-8 py-4 bg-indigo-600 text-white font-black text-lg rounded-2xl shadow-[0_0_40px_-5px_rgba(79,70,229,0.4)] hover:shadow-[0_0_50px_-5px_rgba(79,70,229,0.6)] hover:bg-indigo-500 transition-all duration-500 flex items-center gap-3 overflow-hidden">
                        <span class="relative z-10">Lihat Portofolio</span>
                        <i data-lucide="code" class="w-5 h-5 relative z-10 transition-transform duration-500 group-hover:scale-110"></i>
                        <div class="absolute inset-0 bg-gradient-to-r from-indigo-400/0 via-white/10 to-indigo-400/0 -translate-x-[100%] group-hover:translate-x-[100%] transition-transform duration-1000 ease-in-out"></div>
                    </a>
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="grid lg:grid-cols-2 gap-24 items-start">
                <div class="space-y-12 sticky top-32">
                    ...
                    <div class="p-6 bg-indigo-50 rounded-[32px] border border-indigo-100 flex items-center gap-5 group hover:bg-white hover:shadow-2xl transition-all duration-500">
                        <div class="w-14 h-14 bg-indigo-600 text-white rounded-xl flex items-center justify-center flex-shrink-0 animate-pulse">
                    ...
                    <div class="p-8 bg-slate-50 border border-slate-100 rounded-[40px] hover:bg-white hover:shadow-2xl hover:-translate-y-2 transition-all duration-500 group">
                        <div class="flex gap-6 items-start">
                            ...
                            <div class="space-y-3">
                                ...
                                <p class="text-slate-600 leading-relaxed">Otomatisasi proses bisnis (ERP) dan pengembangan middleware untuk efisiensi operasional.</p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="p-8 bg-slate-50 border border-slate-100 rounded-[40px] hover:bg-white hover:shadow-2xl hover:-translate-y-2 transition-all duration-500 group">
                        <div class="flex gap-6 items-start">
                            ...
                            <div class="space-y-3">
                                ...
                                <p class="text-slate-600 leading-relaxed">Pengembangan website korporat yang representatif, aman, dan dioptimalkan untuk SEO.</p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="p-8 bg-slate-50 border border-slate-100 rounded-[40px] hover:bg-white hover:shadow-2xl hover:-translate-y-2 transition-all duration-500 group">
                        <div class="flex gap-6 items-start">
                            ...
                            <div class="space-y-3">
                                ...
                                <p class="text-slate-600 leading-relaxed">Platform toko online kustom dengan integrasi pembayaran dan logistik yang mulus.</p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="p-8 bg-slate-50 border border-slate-100 rounded-[40px] hover:bg-white hover:shadow-2xl hover:-translate-y-2 transition-all duration-500 group">
                        <div class="flex gap-6 items-start">
                            ...
                            <div class="space-y-3">
                                ...
                                <p class="text-slate-600 leading-relaxed">Perancangan antarmuka pengguna yang intuitif dan pengalaman digital yang menyenangkan.</p>
                            </div>
                        </div>
                    </div>
                </div>
    ...
    <section class="py-16 bg-slate-900 relative overflow-hidden">
        <!-- Abstract Decoration -->
        <div class="absolute top-0 right-0 w-full h-full bg-[radial-gradient(circle_at_80%_20%,#1e1b4b_0%,transparent_50%)]"></div>
        ...
        <div class="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center space-y-20">
            ...
            <div class="relative bg-white/5 backdrop-blur-2xl border border-white/10 rounded-[48px] p-10 md:p-14 shadow-3xl group overflow-hidden">
                ...
                <div class="grid md:grid-cols-3 gap-10 relative z-10">
                    <div class="space-y-4">
                        <div class="text-5xl md:text-7xl font-display font-black text-white leading-none tracking-tighter group-hover:text-indigo-400 transition-colors duration-700">99.9%</div>
                        <div class="w-12 h-1 bg-indigo-500 mx-auto rounded-full"></div>
                        <p class="text-slate-400 text-lg">Uptime rata-rata di seluruh infrastruktur cloud yang kami kelola.</p>
                    </div>
                    <div class="space-y-4">
                        <div class="text-5xl md:text-7xl font-display font-black text-white leading-none tracking-tighter group-hover:text-indigo-400 transition-colors duration-700">500k+</div>
                        <div class="w-12 h-1 bg-indigo-500 mx-auto rounded-full"></div>
                        <p class="text-slate-400 text-lg">Baris kode yang telah kami tulis dalam berbagai proyek kustom.</p>
                    </div>
                    <div class="space-y-4">
                        <div class="text-5xl md:text-7xl font-display font-black text-white leading-none tracking-tighter group-hover:text-indigo-400 transition-colors duration-700">20+</div>
                        <div class="w-12 h-1 bg-indigo-500 mx-auto rounded-full"></div>
            ...
            <div class="grid md:grid-cols-3 gap-6">
                <div class="group relative p-8 bg-white rounded-[40px] shadow-sm border border-slate-100 hover:shadow-2xl transition-all duration-700 overflow-hidden">
                    ...
                    <div class="relative z-10 space-y-6">
                        ...
                        <p class="text-slate-600 text-lg leading-relaxed">
                            <span class="text-slate-900 font-bold">ADMA</span> menentukan kebutuhan platform pemasaran, dan <span class="text-slate-900 font-bold">ADDS</span> membangun infrastrukturnya agar siap dijalankan.
                        </p>
                    </div>
                </div>
                ...
                <div class="group relative p-8 bg-white rounded-[40px] shadow-sm border border-slate-100 hover:shadow-2xl transition-all duration-700 overflow-hidden">
                    ...
                    <div class="relative z-10 space-y-6">
                        ...
                        <p class="text-slate-600 text-lg leading-relaxed">
                            <span class="text-slate-900 font-bold">ADDS</span> melengkapi aset media <span class="text-slate-900 font-bold">ADMO</span> dengan fitur teknis yang meningkatkan konversi monetisasi.
                        </p>
                    </div>
                </div>
                ...
                <div class="group relative p-8 bg-white rounded-[40px] shadow-sm border border-slate-100 hover:shadow-2xl transition-all duration-700 overflow-hidden">
                    ...
                    <div class="relative z-10 space-y-6">
                        ...
                        <p class="text-slate-600 text-lg leading-relaxed">
                            <span class="text-slate-900 font-bold">APEX</span> menyediakan aset desain kreatif, dan <span class="text-slate-900 font-bold">ADDS</span> mengintegrasikannya ke dalam antarmuka aplikasi yang berfungsi penuh.
                        </p>
                    </div>
                </div>
            </div>
