...
@section('content')
    <div class="min-h-screen bg-[#020617] flex items-center justify-center p-4 relative overflow-hidden">
        ...
        <div class="absolute inset-0 z-0">
            ...
            <div class="absolute bottom-[-10%] left-[-5%] w-[400px] h-[400px] bg-indigo-600/10 blur-[100px] rounded-full">
            </div>
        </div>
        ...
        <div class="relative z-10 w-full max-w-md animate-fade-in">
            <div class="bg-white/5 backdrop-blur-2xl border border-white/10 rounded-[48px] p-10 md:p-14 shadow-3xl">
                <div class="text-center mb-10 space-y-2">
                    <div
                        class="inline-flex items-center justify-center w-16 h-16 bg-blue-600 rounded-2xl mb-6 shadow-lg shadow-blue-600/20">
                ...
                <form action="{{ route('login') }}" method="POST" class="space-y-6">
                    ...
                    <div class="pt-4">
                        <button type="submit"
                            class="w-full py-4 bg-blue-600 text-white font-black text-lg rounded-2xl shadow-xl shadow-blue-600/20 hover:bg-blue-500 hover:shadow-blue-600/40 active:scale-[0.98] transition-all duration-300">
                            Sign In
                        </button>
                    </div>
                </form>
                ...
                <div class="mt-10 text-center">
                    <a href="/"
                        class="text-slate-500 hover:text-white transition-colors text-xs font-bold uppercase tracking-widest flex items-center justify-center gap-2">
